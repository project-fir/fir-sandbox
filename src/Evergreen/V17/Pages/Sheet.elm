module Evergreen.V17.Pages.Sheet exposing (..)

import Array
import Browser.Dom
import Evergreen.V17.Array2D
import Evergreen.V17.DuckDb
import Evergreen.V17.SheetModel
import File
import Http
import RemoteData
import Set
...
type alias RawPrompt =
    ( Evergreen.V17.SheetModel.RawPromptString, ( Evergreen.V17.Array2D.RowIx, Evergreen.V17.Array2D.ColIx ) )
...
type alias Model =
    { sheet : Evergreen.V17.SheetModel.SheetEnvelope
    , sheetMode : DataInspectMode
    , keysDown : Set.Set KeyCode
    , selectedCell : Maybe Evergreen.V17.SheetModel.Cell
    , promptMode : PromptMode
    , submissionHistory : List RawPrompt
    , timeline : Array.Array Timeline
    , uiMode : UiMode
    , duckDbResponse : RemoteData.WebData Evergreen.V17.DuckDb.DuckDbQueryResponse
...
type Msg
    ...
    | ClickedCell Evergreen.V17.SheetModel.CellCoords
