module Evergreen.V22.Pages.Sheet exposing (..)

import Array
import Browser.Dom
import Evergreen.V22.Array2D
import Evergreen.V22.DuckDb
import Evergreen.V22.SheetModel
import File
import Http
import RemoteData
import Set
...
type alias RawPrompt =
    ( Evergreen.V22.SheetModel.RawPromptString, ( Evergreen.V22.Array2D.RowIx, Evergreen.V22.Array2D.ColIx ) )
...
type alias Model =
    { sheet : Evergreen.V22.SheetModel.SheetEnvelope
    , sheetMode : DataInspectMode
    , keysDown : Set.Set KeyCode
    , selectedCell : Maybe Evergreen.V22.SheetModel.Cell
    , promptMode : PromptMode
    , submissionHistory : List RawPrompt
    , timeline : Array.Array Timeline
    , uiMode : UiMode
    , duckDbResponse : RemoteData.WebData Evergreen.V22.DuckDb.DuckDbQueryResponse
...
type Msg
    ...
    | ClickedCell Evergreen.V22.SheetModel.CellCoords
