module Evergreen.V28.DimensionalModel exposing (..)
...
type alias DimModelDuckDbSourceInfo =
    ...
    , assignment : KimballAssignment Evergreen.V28.DuckDb.DuckDbRef_ (List Evergreen.V28.DuckDb.DuckDbColumnDescription)
    , isIncluded : Bool
    }
...
type alias ColumnGraph =
    Graph.Graph Evergreen.V28.DuckDb.DuckDbColumnDescription EdgeLabel


type alias DimensionalModel =
    { ref : DimensionalModelRef
    , tableInfos : Dict.Dict Evergreen.V28.DuckDb.DuckDbRefString DimModelDuckDbSourceInfo
    , graph : ColumnGraph
    }
