module Evergreen.V28.Pages.Admin exposing (..)
...
type alias Model =
    ...
    , selectedDimModel : Maybe Evergreen.V28.DimensionalModel.DimensionalModel
...
type Msg
    ...
    | UserClickedDimModelRow Evergreen.V28.DimensionalModel.DimensionalModelRef
    | GotBackendData
        { sessionIds : List Lamdera.SessionId
        , dimensionalModels : Dict.Dict Evergreen.V28.DimensionalModel.DimensionalModelRef Evergreen.V28.DimensionalModel.DimensionalModel
        , duckDbCache : Evergreen.V28.Bridge.DuckDbCache_
