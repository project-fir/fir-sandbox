module Evergreen.V28.Pages.Sheet exposing (..)

import Array
import Browser.Dom
import Evergreen.V28.Array2D
import Evergreen.V28.DuckDb
import Evergreen.V28.SheetModel
import File
import Http
import RemoteData
import Set
...
type alias RawPrompt =
    ( Evergreen.V28.SheetModel.RawPromptString, ( Evergreen.V28.Array2D.RowIx, Evergreen.V28.Array2D.ColIx ) )
...
type alias Model =
    { sheet : Evergreen.V28.SheetModel.SheetEnvelope
    , sheetMode : DataInspectMode
    , keysDown : Set.Set KeyCode
    , selectedCell : Maybe Evergreen.V28.SheetModel.Cell
    , promptMode : PromptMode
    , submissionHistory : List RawPrompt
    , timeline : Array.Array Timeline
    , uiMode : UiMode
    , duckDbResponse : RemoteData.WebData Evergreen.V28.DuckDb.DuckDbQueryResponse
...
type Msg
    ...
    | ClickedCell Evergreen.V28.SheetModel.CellCoords
