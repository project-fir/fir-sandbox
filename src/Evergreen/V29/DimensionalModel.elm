module Evergreen.V29.DimensionalModel exposing (..)
...
type alias DimModelDuckDbSourceInfo =
    ...
    , assignment : KimballAssignment Evergreen.V29.DuckDb.DuckDbRef_ (List Evergreen.V29.DuckDb.DuckDbColumnDescription)
    , isIncluded : Bool
    }
...
type alias ColumnGraph =
    Graph.Graph Evergreen.V29.DuckDb.DuckDbColumnDescription EdgeLabel


type alias DimensionalModel =
    { ref : DimensionalModelRef
    , tableInfos : Dict.Dict Evergreen.V29.DuckDb.DuckDbRefString DimModelDuckDbSourceInfo
    , graph : ColumnGraph
    }
