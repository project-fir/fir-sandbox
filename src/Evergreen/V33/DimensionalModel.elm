module Evergreen.V33.DimensionalModel exposing (..)
...
type alias DimModelDuckDbSourceInfo =
    ...
    , assignment : KimballAssignment Evergreen.V33.DuckDb.DuckDbRef_ (List Evergreen.V33.DuckDb.DuckDbColumnDescription)
    , isIncluded : Bool
    }
...
type alias ColumnGraph =
    Graph.Graph Evergreen.V33.DuckDb.DuckDbColumnDescription EdgeLabel


type alias DimensionalModel =
    { ref : DimensionalModelRef
    , tableInfos : Dict.Dict Evergreen.V33.DuckDb.DuckDbRefString DimModelDuckDbSourceInfo
    , graph : ColumnGraph
    }
