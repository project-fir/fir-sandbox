module Evergreen.V35.Pages.Sheet exposing (..)

import Array
import Browser.Dom
import Evergreen.V35.Array2D
import Evergreen.V35.DuckDb
import Evergreen.V35.SheetModel
...
type alias RawPrompt =
    ( Evergreen.V35.SheetModel.RawPromptString, ( Evergreen.V35.Array2D.RowIx, Evergreen.V35.Array2D.ColIx ) )
...
type alias Model =
    { sheet : Evergreen.V35.SheetModel.SheetEnvelope
    , sheetMode : DataInspectMode
    , keysDown : Set.Set Evergreen.V35.Utils.KeyCode
    , selectedCell : Maybe Evergreen.V35.SheetModel.Cell
    , promptMode : PromptMode
    , submissionHistory : List RawPrompt
    , timeline : Array.Array Timeline
    , uiMode : UiMode
    , duckDbResponse : RemoteData.WebData Evergreen.V35.DuckDb.DuckDbQueryResponse
...
type Msg
    ...
    | ClickedCell Evergreen.V35.SheetModel.CellCoords
