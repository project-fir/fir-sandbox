module Evergreen.V36.Pages.Sheet exposing (..)

import Array
import Browser.Dom
import Evergreen.V36.Array2D
import Evergreen.V36.DuckDb
import Evergreen.V36.SheetModel
...
type alias RawPrompt =
    ( Evergreen.V36.SheetModel.RawPromptString, ( Evergreen.V36.Array2D.RowIx, Evergreen.V36.Array2D.ColIx ) )
...
type alias Model =
    { sheet : Evergreen.V36.SheetModel.SheetEnvelope
    , sheetMode : DataInspectMode
    , keysDown : Set.Set Evergreen.V36.Utils.KeyCode
    , selectedCell : Maybe Evergreen.V36.SheetModel.Cell
    , promptMode : PromptMode
    , submissionHistory : List RawPrompt
    , timeline : Array.Array Timeline
    , uiMode : UiMode
    , duckDbResponse : RemoteData.WebData Evergreen.V36.DuckDb.DuckDbQueryResponse
...
type Msg
    ...
    | ClickedCell Evergreen.V36.SheetModel.CellCoords
