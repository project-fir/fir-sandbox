module Evergreen.V48.Pages.Sheet exposing (..)

import Array
import Browser.Dom
import Evergreen.V48.Array2D
import Evergreen.V48.DuckDb
import Evergreen.V48.SheetModel
...
type alias RawPrompt =
    ( Evergreen.V48.SheetModel.RawPromptString, ( Evergreen.V48.Array2D.RowIx, Evergreen.V48.Array2D.ColIx ) )
...
type alias Model =
    { sheet : Evergreen.V48.SheetModel.SheetEnvelope
    , sheetMode : DataInspectMode
    , keysDown : Set.Set Evergreen.V48.Utils.KeyCode
    , selectedCell : Maybe Evergreen.V48.SheetModel.Cell
    , promptMode : PromptMode
    , submissionHistory : List RawPrompt
    , timeline : Array.Array Timeline
    , uiMode : UiMode
    , duckDbResponse : RemoteData.WebData Evergreen.V48.DuckDb.DuckDbQueryResponse
...
type Msg
    ...
    | KeyWentDown Evergreen.V48.Utils.KeyCode
    | KeyReleased Evergreen.V48.Utils.KeyCode
    | UserSelectedTableRef Evergreen.V48.DuckDb.DuckDbRef
    | UserMouseEnteredTableRef Evergreen.V48.DuckDb.DuckDbRef
    | UserMouseLeftTableRef
    | ClickedCell Evergreen.V48.SheetModel.CellCoords
