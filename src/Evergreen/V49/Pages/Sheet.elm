module Evergreen.V49.Pages.Sheet exposing (..)

import Array
import Browser.Dom
import Evergreen.V49.Array2D
import Evergreen.V49.DuckDb
import Evergreen.V49.SheetModel
...
type alias RawPrompt =
    ( Evergreen.V49.SheetModel.RawPromptString, ( Evergreen.V49.Array2D.RowIx, Evergreen.V49.Array2D.ColIx ) )
...
type alias Model =
    { sheet : Evergreen.V49.SheetModel.SheetEnvelope
    , sheetMode : DataInspectMode
    , keysDown : Set.Set Evergreen.V49.Utils.KeyCode
    , selectedCell : Maybe Evergreen.V49.SheetModel.Cell
    , promptMode : PromptMode
    , submissionHistory : List RawPrompt
    , timeline : Array.Array Timeline
    , uiMode : UiMode
    , duckDbResponse : RemoteData.WebData Evergreen.V49.DuckDb.DuckDbQueryResponse
...
type Msg
    ...
    | KeyWentDown Evergreen.V49.Utils.KeyCode
    | KeyReleased Evergreen.V49.Utils.KeyCode
    | UserSelectedTableRef Evergreen.V49.DuckDb.DuckDbRef
    | UserMouseEnteredTableRef Evergreen.V49.DuckDb.DuckDbRef
    | UserMouseLeftTableRef
    | ClickedCell Evergreen.V49.SheetModel.CellCoords
