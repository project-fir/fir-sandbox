module Evergreen.V50.DimensionalModel exposing (..)
...
type alias DimModelDuckDbSourceInfo =
    ...
    , assignment : KimballAssignment Evergreen.V50.DuckDb.DuckDbRef_ (List Evergreen.V50.DuckDb.DuckDbColumnDescription)
    , isIncluded : Bool
    }
...
type alias ColumnGraph =
    Graph.Graph Evergreen.V50.DuckDb.DuckDbColumnDescription EdgeLabel


type alias DimensionalModel =
    { ref : DimensionalModelRef
    , tableInfos : Dict.Dict Evergreen.V50.DuckDb.DuckDbRefString DimModelDuckDbSourceInfo
    , graph : ColumnGraph
    }
