module Evergreen.V52.DimensionalModel exposing (..)
...
type alias DimModelDuckDbSourceInfo =
    ...
    , assignment : KimballAssignment Evergreen.V52.DuckDb.DuckDbRef_ (List Evergreen.V52.DuckDb.DuckDbColumnDescription)
    , isIncluded : Bool
    }
...
type alias ColumnGraph =
    Graph.Graph Evergreen.V52.DuckDb.DuckDbColumnDescription EdgeLabel


type alias DimensionalModel =
    { ref : DimensionalModelRef
    , tableInfos : Dict.Dict Evergreen.V52.DuckDb.DuckDbRefString DimModelDuckDbSourceInfo
    , graph : ColumnGraph
    }
