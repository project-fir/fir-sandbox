module Evergreen.V62.Pages.Admin exposing (..)
...
type alias Model =
    ...
    , selectedDimModel : Maybe Evergreen.V62.DimensionalModel.DimensionalModel
...
type Msg
    ...
    | UserClickedDimModelRow Evergreen.V62.DimensionalModel.DimensionalModelRef
    | GotBackendData
        { sessionIds : List Lamdera.SessionId
        , dimensionalModels : Dict.Dict Evergreen.V62.DimensionalModel.DimensionalModelRef Evergreen.V62.DimensionalModel.DimensionalModel
        , duckDbCache : Evergreen.V62.Bridge.DuckDbCache_
