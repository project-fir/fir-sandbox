module Evergreen.V62.Pages.Sheet exposing (..)

import Array
import Browser.Dom
import Evergreen.V62.Array2D
import Evergreen.V62.DuckDb
import Evergreen.V62.SheetModel
...
type alias RawPrompt =
    ( Evergreen.V62.SheetModel.RawPromptString, ( Evergreen.V62.Array2D.RowIx, Evergreen.V62.Array2D.ColIx ) )
...
type alias Model =
    { sheet : Evergreen.V62.SheetModel.SheetEnvelope
    , sheetMode : DataInspectMode
    , keysDown : Set.Set Evergreen.V62.Utils.KeyCode
    , selectedCell : Maybe Evergreen.V62.SheetModel.Cell
    , promptMode : PromptMode
    , submissionHistory : List RawPrompt
    , timeline : Array.Array Timeline
    , uiMode : UiMode
    , duckDbResponse : RemoteData.WebData Evergreen.V62.DuckDb.DuckDbQueryResponse
...
type Msg
    ...
    | KeyWentDown Evergreen.V62.Utils.KeyCode
    | KeyReleased Evergreen.V62.Utils.KeyCode
    | UserSelectedTableRef Evergreen.V62.DuckDb.DuckDbRef
    | UserMouseEnteredTableRef Evergreen.V62.DuckDb.DuckDbRef
    | UserMouseLeftTableRef
    | ClickedCell Evergreen.V62.SheetModel.CellCoords
